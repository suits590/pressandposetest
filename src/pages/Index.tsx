...
const Index = () => {
  ...
  const whyChooseUs = [{
    ...
    title: "Tampa Focused",
    description: "Proudly serving Tampa's most distinguished events"
  }];
  return <Layout>
      {/* Hero Section */}
      <section className="relative min-h-[90vh] flex items-center">
        <div className="absolute inset-0">
          <img src={heroImage} alt="Luxury photo booth at elegant Tampa wedding reception" className="w-full h-full object-cover" />
        ...
        <div className="container-luxury relative z-10">
          <div className="max-w-2xl animate-fade-in-up">
            <h1 className="text-display md:text-display-lg lg:text-display-xl font-serif text-foreground mb-6">
              Luxury Photo Booth Rentals for Tampa's Finest Events
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-10 max-w-lg">
              Elevate your celebration with an unforgettable photo experience. 
              Refined elegance meets modern sophistication.
            </p>
      ...
      <section className="section-padding bg-background">
        <div className="container-luxury">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">Press & Pose delivers photo booth experiences designed for those who appreciate the finer details. From intimate gatherings to grand celebrations, we bring studio-quality photography directly to your event with an aesthetic that seamlessly integrates into your carefully curated atmosphere.</p>
          </div>
        </div>
      </section>
        ...
        <div className="container-luxury">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto">
              Select the perfect experience for your Tampa event
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            animationDelay: `${index * 100}ms`
                ...
                <div className="image-hover rounded-sm overflow-hidden mb-6">
                  <img src={service.image} alt={`${service.title} photo booth rental in Tampa`} className="w-full aspect-[3/4] object-cover" />
                </div>
        ...
        <div className="container-luxury">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="image-hover rounded-sm overflow-hidden">
              <img src={glamImage} alt="Elegant photo booth experience in Tampa" className="w-full aspect-square object-cover" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-card">
        <div className="container-luxury">
          <div className="text-center mb-16">
            <h2 className="text-heading-lg md:text-display font-serif text-foreground mb-4">
              The Tampa Photo Booth Difference
            </h2>
            <p className="text-muted-foreground max-w-xl mx-auto">
